...
namespace MediaTekDocuments.view
{
    ...
    public partial class FrmAuthentification : Form
    {
        ...
        /// <summary>
        /// Clic sur le bouton "Se connecter" et vérifie les droits de l'utilisateur
        /// </summary>
        ...
        private void btnAuthConnect_Click(object sender, EventArgs e)
        {
            ...
            if (utilisateurEnCours != null)
            {
                ...
                {
                    MessageBox.Show("Vous n'avez pas les droits d'accéder à l'application", "Avertissement");
            ...
            {
                MessageBox.Show("Les identifiants saisis incorrects", "Avertissement");
            }
        }
    } 
}