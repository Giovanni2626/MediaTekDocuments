...
namespace MediaTekDocuments.dal
{
    ...
    public class Access
    {
        ...
        /// adresse de l'API
        /// </summary>
        private static readonly string uriApi = "http://127.0.0.1/rest_mediatekdocuments/rest_mediatekdocuments-master/";
        /// <summary>
        ...
        private Access()
{
    try
    {
        // Récupération sécurisée depuis le App.config
    ...
    {
        Console.WriteLine("Erreur d'initialisation de l'API : " + e.Message);
        Environment.Exit(0);
    }
}
